const Data = {
  ...
  // Welcome string on home splash screen,
  homeScreenGreeting: "Come and check out our stuff!",
  ...
  // Future items: logo used,
};

// Starter values for store.
export const DUMMY_PRODUCT_LIST = [
  ...
  { id: 4, item: "Hat", cost: 12.25, categories: "accessory" },
